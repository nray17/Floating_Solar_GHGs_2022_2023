...
lsmeans(top_co2_model, pairwise ~ treatment*pre_post)
...
top_co2_box = ggplot()+
  ...
  theme(axis.text.x =  element_text(size = 8,colour = "black"),
        ...
        axis.title.y = element_markdown(size = 8))+
  theme(legend.position = "NULL")+
  annotate("text", x = 1, y = 200, label = "p < 0.001", size = 2.822,  fontface = "italic")
...
lsmeans(bottom_co2_model, pairwise ~ treatment*pre_post)
...
bottom_co2_box = ggplot()+
  ...
  theme(axis.text.x =  element_text(size = 8,colour = "black"),
        ...
        axis.title.y = element_markdown(size = 8))+
  theme(legend.position = "NULL")+
  annotate("text", x = 1, y = 800, label = "p < 0.001", size = 2.822,  fontface = "italic")
...
lsmeans(top_ch4_model, pairwise ~ treatment*pre_post)
...
top_ch4_box = ggplot()+
  ...
  theme(axis.text.x =  element_text(size = 8,colour = "black"),
        ...
        axis.title.y = element_markdown(size = 8))+
  theme(legend.position = "NULL")+
  annotate("text", x = 1, y = 30, label = "p = 0.031", size = 2.822,  fontface = "italic")
top_ch4_box
...
lsmeans(bottom_ch4_model, pairwise ~ treatment*pre_post)
...
bottom_ch4_box = ggplot()+
  ...
  theme(axis.text.x =  element_text(size = 8,colour = "black"),
        ...
        axis.title.y = element_markdown(size = 8))+
  theme(legend.position = "NULL")+
  annotate("text", x = 1, y = 800, label = "p = 0.004", size = 2.822,  fontface = "italic")
...
lsmeans(eb_ch4_vol_model, pairwise ~ treatment*pre_post)
...
bubble_vol_box = ggplot()+
  ...
  theme(axis.text.x =  element_text(size = 8,colour = "black"),
        ...
        axis.title.y = element_markdown(size = 8))+
  theme(legend.position = "NULL")+
  annotate("text", x = 1, y = 35, label = "p = 0.955", size = 2.822,  fontface = "italic")
bubble_vol_box
...
lsmeans(eb_ch4_conc_model, pairwise ~ treatment*pre_post)
...
bubble_conc_box = ggplot()+
  ...
  theme(axis.text.x =  element_text(size = 8,colour = "black"),
        ...
        axis.title.y = element_markdown(size = 8))+
  theme(legend.position = "NULL")+
  annotate("text", x = 1, y = 100, label = "p < 0.001", size = 2.822,  fontface = "italic")
bubble_conc_box
...
lsmeans(eb_ch4_model, pairwise ~ treatment*pre_post)
...
eb_ch4_box = ggplot()+
  ...
  theme(axis.text.x =  element_text(size = 8,colour = "black"),
        ...
        axis.title.y = element_markdown(size = 8))+
  theme(legend.position = "NULL")+
  annotate("text", x = 1, y = 0.75, label = "p = 0.031", size = 2.822,  fontface = "italic")
eb_ch4_box
